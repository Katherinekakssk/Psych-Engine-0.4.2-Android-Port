function onCreate()
	...
	Dodged = false;
    canDodge = false;
    addCharacterToList('BFCHARAdodge', 'boyfriend')
end

function onEvent(name, value1, value2)
    if name == "DodgeEventChara" then
	playSound('alert', 0.7);
...
Dodged = true;
triggerEvent('Change Character','bf','BFCHARAdodge');
...
triggerEvent('Change Character','BFCHARAdodge','bfChara');
 end
end