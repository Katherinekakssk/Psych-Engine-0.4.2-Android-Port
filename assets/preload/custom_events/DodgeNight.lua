function onCreate()
	...
	Dodged = false;
    canDodge = false;
    addCharacterToList('BF-BS-shader', 'boyfriend')
end

function onEvent(name, value1, value2)
    if name == "DodgeNight" then
	playSound('alert', 0.7);
...
Dodged = true;
triggerEvent('Change Character','bf','BF-BS-shader');
...
triggerEvent('Change Character','BF-BS-shader','bfNight');
 end
end